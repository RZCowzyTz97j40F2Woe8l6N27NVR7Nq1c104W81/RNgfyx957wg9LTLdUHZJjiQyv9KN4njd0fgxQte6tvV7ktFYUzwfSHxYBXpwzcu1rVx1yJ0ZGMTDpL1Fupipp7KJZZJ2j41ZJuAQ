...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-everything --disable-doc --disable-debug --disable-network --disable-autodetect --disable-ffprobe --disable-ffplay --enable-gpl --enable-libx264 --enable-small --enable-protocol='file,pipe' --enable-demuxer='rawvideo,wav,mov' --enable-muxer=mp4 --enable-decoder='rawvideo,pcm_s16le,pcm_f32le' --enable-encoder='libx264,aac' --enable-parser='h264,aac' --enable-filter='scale,format,aresample,aformat,anull,null' --enable-bsf=aac_adtstoasc --enable-swscale --enable-swresample --extra-ldflags=-static --pkg-config-flags=--static
prefix=/usr/local
...
CC_IDENT=gcc 15.2.0 (Rev13, Built by MSYS2 project)
ARCH=x86
INTRINSICS=sse2
EXTERN_PREFIX=
CC=gcc
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC11_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DWIN32_LEAN_AND_MEAN -D__USE_MINGW_ANSI_STDIO=1 -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -I$(SRC_PATH)/compat/stdbit
CFLAGS=   -std=c17 -U__STRICT_ANSI__ -fomit-frame-pointer -DX264_API_IMPORTS -UX264_API_IMPORTS -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wstack-usage=122880 -Wmissing-prototypes -Wstrict-prototypes -Wunterminated-string-initialization -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Os -fno-math-errno -fno-signed-zeros -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=format-security -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=   -D__STDC_CONSTANT_MACROS -std=c++17 -fomit-frame-pointer -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wstack-usage=122880 -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Os -fno-math-errno -fno-signed-zeros -Werror=format-security -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
OBJCFLAGS=  
ASFLAGS=  
GLSLCFLAGS=
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -static  -Wl,--nxcompat,--dynamicbase -Wl,--high-entropy-va -Wl,--as-needed -Wl,-rpath-link=:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS= -Wl,--pic-executable,-e,mainCRTStartup -Wl,--image-base,0x140000000
LDSOFLAGS=
...
HOSTCC=gcc
HOSTLD=gcc
HOSTCFLAGS=  -std=c17 -Wall -O3 -U__STRICT_ANSI__
HOSTCPPFLAGS= -D_ISOC11_SOURCE -D__USE_MINGW_ANSI_STDIO=1 -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
HOSTEXESUF=.exe
HOSTLDFLAGS= 
HOSTEXTRALIBS=-lm
DEPHOSTCC=gcc
...
EXTRALIBS-avcodec=-lm -latomic -lx264 -lole32 -luser32
