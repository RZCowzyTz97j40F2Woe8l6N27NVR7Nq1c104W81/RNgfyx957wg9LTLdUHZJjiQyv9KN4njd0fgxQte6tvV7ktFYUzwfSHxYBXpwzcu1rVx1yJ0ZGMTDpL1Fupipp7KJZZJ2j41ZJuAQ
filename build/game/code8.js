...
gdjs.creditsCode.GDchristmasLightObjects1= [];
gdjs.creditsCode.GDchristmasLightObjects2= [];
gdjs.creditsCode.GDchristmasLightObjects3= [];
gdjs.creditsCode.GDchristmasLightObjects4= [];
...
{for(var i = 0, len = gdjs.creditsCode.GDtransitionObjects2.length ;i < len;++i) {
    gdjs.creditsCode.GDtransitionObjects2[i].getBehavior("FlashTransitionPainter").PaintEffect("0;0;0", 0.2, "Circular", "Backward", 0, null);
}
}
}
...
if (true)
{
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.creditsCode.mapOfGDgdjs_9546creditsCode_9546GDcreditsObjects2Objects, 0, 240 + gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("spacing")) + gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("creditsX")) * 11, "");
}
...
gdjs.creditsCode.asyncCallback45582444 = function (runtimeScene, asyncObjectsList) {
...
gdjs.creditsCode.idToCallbackMap.set(45582444, gdjs.creditsCode.asyncCallback45582444);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.creditsCode.asyncCallback45582444(runtimeScene, asyncObjectsList)), 45582444, asyncObjectsList);
}
}
...
{for(var i = 0, len = gdjs.creditsCode.GDtransitionObjects1.length ;i < len;++i) {
    gdjs.creditsCode.GDtransitionObjects1[i].getBehavior("FlashTransitionPainter").PaintEffect("0;0;0", 0.2, "Circular", "Forward", 0, null);
}
}
...
gdjs.creditsCode.asyncCallback45588892 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.creditsCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "mainmenu", true);
}
gdjs.creditsCode.localVariables.length = 0;
}
gdjs.creditsCode.idToCallbackMap.set(45588892, gdjs.creditsCode.asyncCallback45588892);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.creditsCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.creditsCode.asyncCallback45588892(runtimeScene, asyncObjectsList)), 45588892, asyncObjectsList);
}
}
...
for (var i = 0, k = 0, l = gdjs.creditsCode.GDbackbuttonObjects1.length;i<l;++i) {
    if ( gdjs.creditsCode.GDbackbuttonObjects1[i].isVisible() ) {
...
{gdjs.evtsExt__JSONResourceLoader__LoadJSONToScene.func(runtimeScene, "credits.json", runtimeScene.getScene().getVariables().get("credits"), null);
}
...
gdjs.creditsCode.GDchristmasLightObjects1.length = 0;
gdjs.creditsCode.GDchristmasLightObjects2.length = 0;
gdjs.creditsCode.GDchristmasLightObjects3.length = 0;
gdjs.creditsCode.GDchristmasLightObjects4.length = 0;
