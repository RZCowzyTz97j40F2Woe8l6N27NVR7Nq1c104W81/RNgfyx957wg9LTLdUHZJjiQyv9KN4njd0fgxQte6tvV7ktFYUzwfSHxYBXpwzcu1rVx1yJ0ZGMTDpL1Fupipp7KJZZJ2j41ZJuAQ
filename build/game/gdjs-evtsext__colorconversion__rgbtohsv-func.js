...
gdjs.evtsExt__ColorConversion__RgbToHsv.idToCallbackMap = new Map();


gdjs.evtsExt__ColorConversion__RgbToHsv.userFunc0x119cb48 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
try {
    const n = eventsFunctionContext.getArgument("n");
    const d = eventsFunctionContext.getArgument("d");
    const col = n.split(";");
    ...
    if (1) {
    eventsFunctionContext.returnValue = (60 * (h < 0 ? h + 6: h)) + ';' + ((v && c / v) * 100) + ';' +  (v * 100);
    } else {
...
gdjs.evtsExt__ColorConversion__RgbToHsv.userFunc0x119cb48(runtimeScene, eventsFunctionContext);
...
gdjs.evtsExt__ColorConversion__RgbToHsv.func = function(runtimeScene, n, d, parentEventsFunctionContext) {
